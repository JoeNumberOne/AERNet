...
class MyDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_item_A_path = os.path.join(self.root_dir, 'A', img_name)  # 每个图片A的位置
        img_item_B_path = os.path.join(self.root_dir, 'B', img_name)  # 每个图片B的位置
        img_item_label_path = os.path.join(self.root_dir, 'label', img_name)  # 每个图片B的位置
        # 读取图片
...
if __name__ == '__main__':
    ...
    print(img_A.size, img_B.size, img_label.size)
